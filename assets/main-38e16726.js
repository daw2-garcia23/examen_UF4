...
const header = {
      ...
      <header>
        <nav class="navbar navbar-light bg-light">
          <div class="container-fluid">
            ...
            <div>
              <button class="btn btn-secondary ms-2" id="panelBoton">PANEL</button>
              <button class="btn btn-secondary ms-2" id="loginBoton">LOGIN</button>
              <button class="btn btn-secondary ms-2" id="registroBoton">REGISTRO</button>
            </div>
            <div>
  ...
  script: () => {
    const panelButton = document.querySelector("#panelBoton");
    panelButton.addEventListener("click", () => {
      document.querySelector("panel").innerHTML = panel.template;
    });
    const loginButton = document.querySelector("#loginBoton");
    loginButton.addEventListener("click", () => {
      document.querySelector("login").innerHTML = login.template;
    });
    const registroButton = document.querySelector("#registroBoton");
